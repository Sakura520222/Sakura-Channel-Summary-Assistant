...
from core.telegram.client import fetch_last_week_messages, send_long_message, send_report
...
async def generate_channel_summary(
    ...
    try:
        ...
        try:
            ...
            from core.telegram.client import extract_date_range_from_summary
