...
STOPWORDS = {
    # 疑问/连接词
    "什么", "什么样", "怎么", "怎样", "如何", "为什么", "为何", "哪里", "哪个", "哪些",
    "是否", "有没有", "有无", "能否", "可以", "是不是",
    # 动词
    "发生", "发布", "更新", "讨论", "介绍", "讲", "说", "看", "查", "找", "帮", "告诉",
    "知道", "了解", "查看", "分析", "总结", "回答", "回复",
    # 代词
    "我", "你", "他", "她", "它", "我们", "你们", "他们", "这", "那", "这个", "那个",
    "这些", "那些", "这里", "那里",
    # 副词/介词/助词
    "最近", "近期", "今天", "昨天", "前天", "本周", "上周", "这周", "本月", "上月",
    "这月", "最新", "新", "旧", "大", "小", "多", "少", "很", "非常", "比较",
    "一些", "一下", "关于", "有关", "的", "了", "吗", "呢", "啊", "吧", "嗯",
    "和", "与", "或", "但", "而", "所以", "因此", "因为", "所以",
    # 频道相关通用词
    "频道", "总结", "内容", "信息", "消息", "新闻", "资讯", "动态",
    "记录", "历史", "过去", "最近", "情况", "进展",
}
...
class IntentParser:
    ...
    def _extract_topics(self, query: str) -> List[str]:
        ...
        topic_patterns = {
            "技术": [r'技术', r'开发', r'编程', r'代码', r'工程', r'算法', r'框架', r'接口', r'API'],
